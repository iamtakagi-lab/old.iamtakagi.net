...
#### Administrator
ラウンジの管理人です。<br/>
主にメンバー登録・ロール管理・Discord管理・フォーラム管理・テーブル更新・プレイヤー処罰管理・ニックネーム管理・サポート対応をしています。

#### Staff
正規スタッフです。<br/>
主にフォーラム管理・ロール管理・テーブル更新・サポート対応理をしています。

#### Updater
アップデーターと読みます。<br/>
主にメンバー登録・テーブル更新・ロール管理・プレイヤー処罰管理・ニックネーム管理・サポート対応をしています。
